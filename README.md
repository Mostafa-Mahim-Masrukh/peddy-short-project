...
In this short project, you can see a pet adoption platform where users can browse and adopt pets. 
We will provide you APIs to fetch pet-related data such as all pets, categories of pets, and specific pet details, pet data based on category    

### **APIs that I use to fetch the data**
...
✅ 5 Best ES6 Features (Commonly Used)
##**let and const**
...
##**Default Parameters**
→ Enables default values for function arguments.

###**Online Site**
*https://peddy-adoption-site.netlify.app/*
